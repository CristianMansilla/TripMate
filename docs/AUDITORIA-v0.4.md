...
Segunda tanda aplicada: edición y eliminación completa de reservas y lugares, con confirmaciones, validación y conservación del orden manual. Tercera tanda aplicada: fechas de itinerario limitadas al viaje también en SQL, protección contra envíos duplicados, foco contenido y restaurado en modales, cambio transaccional de la base del viaje y cantidad de viajeros independiente de los integrantes. La auditoría y reparación de datos históricos también finalizaron sin actividades huérfanas. La repetición básica permite ahora asociar varios días a un solo gasto y elegir si el importe es total o por aparición. Cada aparición también admite paradas o subactividades estructuradas, ordenadas y visibles dentro de la actividad principal; cuando existen, el total del gasto se calcula exclusivamente sumando sus importes. Los formularios de gasto separan datos y presupuesto del itinerario mediante dos pestañas adaptables, sin desplazamiento horizontal. Los skeletons de Dashboard y primera carga del viaje también están implementados. Pendiente para cerrar v0.4: pruebas con dos cuentas reales.
